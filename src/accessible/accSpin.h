 ...
 *  @date   2024.06.25
 *
 *  Copyright (C) 2009-2024 miragekiller
 */
...
///////////////////////////////////////////////////////////////////////////////
// CAccSpin
class TM_NO_VTABLE CAccSpin : public CAccessibleStyle
{
private:
    TM::CRefPtr<IAccessibleStyle>    m_ptrEdit;

public:
    enum { eIndexSelf = 0, eIndexUpLeft, eIndexDownRight, eCount = 2 };
...
//     virtual HRESULT _accNavigate(CAccessibleWnd& sender, long navDir, long varStart, VARIANT* pvarEndUpAt);
    HRESULT _accItemHitTest(CAccessibleWnd& sender, TM::CTuiPoint& pt, long& child);
//     virtual HRESULT _accDoDefaultAction(CAccessibleWnd& sender, long nIndex);
};

extern CAccSpin g_accSpin;
