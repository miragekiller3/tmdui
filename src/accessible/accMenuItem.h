...
#ifndef ACCMENUITEM_H
#define ACCMENUITEM_H
...
///////////////////////////////////////////////////////////////////////////////
// CAccMenuItem
class CAccMenuItem : public CAccessibleStyleButtonBase
{
public:
...
//     virtual HRESULT _get_accDescription(CAccessibleWnd& sender, long nIndex, CComBSTR& description);
    virtual long    _get_accRole(HTUI hWgt, long nIndex) tm_override { return ROLE_SYSTEM_MENUITEM; }
...
extern CAccMenuItem g_accMenuItem;
