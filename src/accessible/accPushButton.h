...
#ifndef ACCPUSHBUTTON_H
#define ACCPUSHBUTTON_H
...
///////////////////////////////////////////////////////////////////////////////
// CAccPushButton
class CAccPushButton : public CAccessibleStyleButtonBase
{
public:
...
//     virtual HRESULT _get_accValue(CAccessibleWnd& sender, long nIndex, CComBSTR& val);
    ...
    virtual HRESULT  _get_accHelp(CAccessibleWnd& sender, long nIndex, CComBSTR& description) tm_override;
...
///////////////////////////////////////////////////////////////////////////////
// CAccCombButton
class CAccCombButton : public CAccPushButton
{
public:
    //     virtual long _get_accItemCount(CAccessibleWnd& sender);
    //     virtual long _get_accItem(CAccessibleWnd& sender, long nIndex, IDispatch** ppRet);  // return -1: succeeded; else return _get_accItemCount();
...
extern CAccPushButton g_accPushButton;
extern CAccCombButton g_accCombButton;
