...
#ifndef ACCSPLITTER_H
#define ACCSPLITTER_H
...
class CAccSplitter : public CAccessibleStyleButtonBase
{
public:
...
//     virtual HRESULT _get_accDescription(CAccessibleWnd& sender, long nIndex, CComBSTR& description);
    virtual long    _get_accRole(HTUI hWgt, long nIndex) tm_override { return ROLE_SYSTEM_SPLITBUTTON; }
...
extern CAccSplitter g_accSplitter;



#endif //with ACCSPLITTER_H