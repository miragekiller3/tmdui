...
#ifndef ACCRADIOBUTTON_H
#define ACCRADIOBUTTON_H
...
///////////////////////////////////////////////////////////////////////////////
// CAccRadioButton
class CAccRadioButton : public CAccessibleStyleButtonBase
{
public:
...
//     virtual HRESULT _get_accDescription(CAccessibleWnd& sender, long nIndex, CComBSTR& description);
    virtual long    _get_accRole(HTUI hWgt, long nIndex) tm_override { return ROLE_SYSTEM_RADIOBUTTON; }
...
extern CAccRadioButton g_accRadioButton;
